    ...
    <body>
        <aside class=" fixed top-0 left-0 bottom-0 z-20 w-60 bg-blue-950 text-white flex flex-col ">
            ...
            <ul class=" mx-4 mt-2 h-full flex flex-col">
                ...
                <li class=" sidebar-toggle mt-auto mb-4"><a class=" text-sm font-bold flex items-center gap-2 mb-1 py-2.5 px-2 rounded-sm bg-white text-blue-600" href="#"><i class="fa-solid fa-angles-right fa-xl rotate-180"></i> <span class=" text-[17px]">Collapse</span></a></li>
            </ul>
        </aside>
